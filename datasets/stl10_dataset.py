...
def get_pretraining_stl10(train_dir, mem_dir, test_dir):
    ...
    memory_data = CIFAR10Mem(numpy_file=mem_dir, class_type= classes, transform=test_transform_stl10)
    #test_data  = CIFAR10Mem(numpy_file=data_dir + "test.npz", class_type= classes,transform=test_transform_stl10)
    test_data  = CIFAR10Mem(numpy_file=test_dir, class_type= classes,transform=test_transform_stl10)
...
def get_shadow_stl10(args):
    ...
    # Fix ad un apparente errore nel codice originale.
    # Sostituito args.pretraining_dataset con args.encoder_usage_info
